...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            commands::acp::acp_read_resource,
            commands::acp::acp_get_tools,
            commands::acp::acp_call_tool,
            commands::acp::acp_list_resources,
            commands::acp::acp_list_resource_templates,
            commands::acp::acp_list_prompts,
            ...
            commands::system::save_downloaded_file,
